          ...
          {!openCopyLink ? (
            <MenuList>
              <div>
                ...
                >
                  <MenuItem>
                    ...
                    <ListItemText inset primary="post.facebookButton" />
                  </MenuItem>
                </FacebookShareButton>
              </div>
              <div>
                ...
                >
                  <MenuItem>
                    ...
                    <ListItemText inset primary="post.twitterButton" />
                  </MenuItem>
                </TwitterShareButton>
              </div>
              <div>
                ...
                >
                  <MenuItem>
                    ...
                    <ListItemText inset primary="post.linkedinButton" />
                  </MenuItem>
                </LinkedinShareButton>
              </div>
              <div>
                ...
                >
                  <MenuItem>
                    ...
                    <ListItemText inset primary="post.googlePlusButton" />
                  </MenuItem>
                </GooglePlusShareButton>
              </div>
              <MenuItem onClick={onCopyLink}>
                ...
                <ListItemText inset primary="post.copyLinkButton" />
              </MenuItem>
            </MenuList>
          ) : (
            <div>
